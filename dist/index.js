...
export class JsCarbon {
    ...
    getFormatter(options = {}) {
        return new Intl.DateTimeFormat(this._locale, Object.assign({ timeZone: this._timezone }, options));
    }
    ...
    isDST() {
        ...
        const getOffset = (date) => {
            return new Date(date.toLocaleString("en-US", { timeZone: this._timezone })).getTimezoneOffset();
        };
    ...
    diffInHoursWithTimezone(timezone) {
        const getCurrentOffset = (tz) => {
            return new Date(this.date.toLocaleString("en-US", { timeZone: tz })).getTimezoneOffset();
        };
    ...
    toLocaleTimeString(options = {}) {
        return this.getFormatter(Object.assign(Object.assign({}, options), { hour: "2-digit", minute: "2-digit", second: "2-digit" })).format(this.date);
    }
    // ローカライズされた日付時刻文字列を取得
    toLocaleString(options = {}) {
        const formatter = this.getFormatter(Object.assign({ year: "numeric", month: "numeric", day: "numeric", hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: false }, options));
